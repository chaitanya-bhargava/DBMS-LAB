...
if con.is_connected() :
    mycursor=con.cursor()
    mycursor.execute("CREATE TABLE customer(cust_num int PRIMARY KEY,cust_lname varchar(30),cust_fname varchar(30) NOT NULL,cust_balance int,cust_dob date)")
    ...
    mycursor.execute("INSERT INTO customer VALUES(101,'Bhargava','Chaitanya',120000,'2003-07-21'),(102,'Uppal','Saksham',60000,'2003-09-19'),(103,'Kumar','Ankit',10000,'2003-04-16'),(104,'Goyal','Aryan',40000,'2003-03-07'),(105,'Dagar','Harsh',27000,'2003-08-14'),(106,'Raval','Mann',0,'2002-11-21'),(107,'Chhabra','Aayush',90000,'2003-11-18'),(108,'Singh','Aadit',90000,'2003-05-01')")
